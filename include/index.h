    ...
    <body onload="init()">
        <div class="container d-flex flex-column mb-3 align-items-center justify-content-center">
            ...
            <div class="d-flex flex-column mb-3 align-items-center">
                ...
                <div class="d-flex flex-column m-3 align-items-center">
                    <span>Niveau de l'eau</span>
                    <span id="waterSensorValue">0</span>
                    <span id="waterSensorLevel">0</span>
                    <div class="progress">
        ...
        <script>
            ...
            function init() {
                ...
                webSocket.onmessage = function (event) {
                    ...
                    document.getElementById("waterSensorValue").innerHTML = data.waterSensor
                    document.getElementById("waterSensorLevel").innerHTML = data.waterSensorLevel
                    //document.getElementById("waterSensor").style.width = data.waterSensor + "%"
                    console.table(data)
                }
            }
